...
const EditOrder = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axiosInstance.get(`/api/v1/checkout/get-order-by-id/${id}`);
                                        ...
                                        <table className="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{orderData?.shippingAddress?.firstName } {orderData?.shippingAddress?.lastName}</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div className="card-body">
                                            {orderData?.items?.map((item, index) => (
                                                <div key={index} className="mb-3">
                                                    ...
                                                    />
                                                    <p className="mb-1">Price: ₹{item?.productId?.finalPrice.toFixed(0) || item?.price}</p>
