...
const AllSubCategory = () => {
    ...
    const handleCheckboxChange = async (e, categoryId) => {
      console.log("categoryId", categoryId);
        ...
        try {
            const response = await axiosInstance.put(`/api/v1/sub-category/update-sub-category/${categoryId}`, {
                        ...
                        {categories?.length > 0 ? (
                            categories?.map((category, index) => (
                                <tr key={category._id}>
                                    ...
                                    <td>
                                        <button className="bt delete" title="Delete"onClick={() => handleDelete(category._id)}>
